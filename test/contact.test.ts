...
describe("POST /api/contacts", () => {
    ...
    it("should create new contact", async () => {
        ...
        expect(response.body.data.last_name).toBe("said");
        expect(response.body.data.email).toBe("ali@eg.com");
        expect(response.body.data.phone).toBe("03992919");
    })
    ...
    it("should reject create new contact if data is invalid", async () => {
        const response = await supertest(web)
            ...
            .send({
                ...
                last_name: "",
                email: "ali",
                phone: "314123123123123123123123"
            })
